...
from app.rag.rewriter.retrieval_query_rewriter import RetrievalQueryRewriter
...
from app.rag.retriever.parallel_retrieval import run_parallel_retrieval, run_parallel_calls
from app.rag.retriever.utils import candidate_to_document, merge_keywords
from app.rag.schemas.routing_schema import RetrievalQuery
...
class RetrievalDebugService:
    ...
    def debug(
        ...
        keywords = merge_keywords(
            ...
            retrieval_query.synonym_keywords,
        )
        # 多查询时每个子查询单独向量召回的数量。
